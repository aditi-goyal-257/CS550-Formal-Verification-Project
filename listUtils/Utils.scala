...
package helper:
    ...
    /* Check if list is reverse sorted by X coordinates */
    ...
    /* Lemma to imply init of reverse sorted list is also reverse sorted */
    @ghostAnnot
    ...
    /* Lemma to imply reverse of reverse sorted list is sorted */
    @ghostAnnot
